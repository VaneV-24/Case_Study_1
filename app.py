...
with gr.Blocks(css=fancy_css) as demo:
    ...
    system_message = gr.Textbox(
        value="You are a recipe assistant Chatbot. Use the user's input ingredients, checked pantry staples, and cooking time to suggest different recipes that can be made within the amount of time specified. If you suggest ingredients that the user does not explictly have, list these as optional.",
